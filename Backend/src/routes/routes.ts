...
import chatBotRouter from "../controllers/chat_bot_controller";
import { USER_BASE_ROUTE, INVITATION_BASE_ROUTE, ITINERARY_BASE_ROUTE, CHATBOT_BASE_ROUTE } from "../utils/constants/route_constants";
...
router.use(CHATBOT_BASE_ROUTE, chatBotRouter);
