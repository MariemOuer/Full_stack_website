      ...
      <Navbar></Navbar>
        <div className="homepage-container">
          ...
          <div className="homepage-text">
            ...
            <p>
              Occasio is your AI-powered event planning assistant, making it
              effortless to organize gatherings of any size. From scheduling and
              guest management to personalized recommendations, we handle the
