  ...
  return (
    <Router>
      <Routes>
        ...
        <Route
          path="/chatbot"
          element={currentUser ? <ChatBotView /> : <Navigate to="/login" />}
        />
        <Route
          path="/events"
          element={currentUser ? <SavedEventsView /> : <Navigate to="/login" />}
        />
        <Route
          path="/view-invitation/:eventId"
          element={
            currentUser ? <ViewInvitationView /> : <Navigate to="/login" />
          }
        />
        <Route
          path="/edit-guest-list/:eventId"
          element={
            currentUser ? <EditGuestListView /> : <Navigate to="/login" />
          }
        />
        <Route
          path="/edit-event-details/:eventId"
          element={
            currentUser ? <EditEventDetailsView /> : <Navigate to="/login" />
          }
        />
